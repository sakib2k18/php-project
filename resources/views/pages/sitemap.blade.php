...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
    @foreach ([['home', '1.0', 'daily'], ['about', '0.8', 'monthly'], ['team', '0.5', 'monthly'], ['get-involved', '0.8', 'monthly'], ['campaigns.index', '0.9', 'daily'], ['projects.index', '0.8', 'weekly'], ['events.index', '0.7', 'weekly'], ['stories.index', '0.7', 'weekly'], ['gallery.index', '0.6', 'weekly'], ['contact.create', '0.6', 'monthly']] as [$name, $priority, $frequency])
        <url>
            <loc>{{ route($name) }}</loc>
